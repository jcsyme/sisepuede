...
def transformation_entc_renewable_target(
    ...
    **kwargs
    ...
    Keyword Arguments
    -----------------
    dict_cats_entc_max_investment : Union[Dict[str, np.ndarray], None]
    ...
    drop_flag : Union[int, float, None]
        ...
        to signal the presence of no constraint. Defaults to 
        model_enerprod.drop_flag_tech_capacities if None
    factor_vec_ramp_msp : Union[float, int, None]
    ...
    magnitude_as_floor : bool
        ...
        a higher share
    magnitude_renewables : Union[Dict[str, float], float, None]
