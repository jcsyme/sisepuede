...
class LivestockDietEstimator:
    """Estimate how livestock split their diet based on crop, residue, and 
        pasture availability. Solves for 7 potential pathways (by index):
    ...
    vec_max_crop_cereals_fraction : np.ndarray
        Vector (n_livstock_categories x 1) of maximum dietary fractions from 
        cereal crops
    vec_max_crop_non_cereals_fraction : np.ndarray
        Vector (n_livstock_categories x 1) of maximum dietary fractions from 
        non-cereal crops
    ...
    vec_max_pastures_fraction : np.ndarray
        Vector (n_livstock_categories x 1) of maximum dietary fractions from 
        pastures
    vec_min_crop_cereals_fraction : np.ndarray
        Vector (n_livstock_categories x 1) of minimum dietary fractions from 
        cereal crops
    vec_min_crop_non_cereals_fraction : np.ndarray
        Vector (n_livstock_categories x 1) of minimum dietary fractions from 
        non-cereal crops
    ...
    def __init__(self,
        ...
        self._initialize_properties(
            n_livstock_categories,
            vec_max_crop_cereals_fraction,
            vec_max_crop_non_cereals_fraction,
            vec_max_crop_residues_fraction,
            vec_max_pastures_fraction,
            vec_min_crop_cereals_fraction,
            vec_min_crop_non_cereals_fraction,
    ...
    def _initialize_properties(self,
        ...
        self.vec_max_crop_cereals_fraction = vec_max_crop_cereals_fraction
        self.vec_max_crop_non_cereals_fraction = vec_max_crop_non_cereals_fraction
        self.vec_max_crop_residues_fraction = vec_max_crop_residues_fraction
        self.vec_max_pastures_fraction = vec_max_pastures_fraction
        self.vec_min_crop_cereals_fraction = vec_min_crop_cereals_fraction
        self.vec_min_crop_non_cereals_fraction = vec_min_crop_non_cereals_fraction
        self.vec_min_crop_residues_fraction = vec_min_crop_residues_fraction
        self.vec_min_pastures_fraction = vec_min_pastures_fraction
